...
if __name__ == '__main__':
    with app.app_context():
        ...
        db.session.add(dye_material_1, dye_material_2, dye_material_3, dye_material_4, dye_material_5, dye_material_6, dye_material_7, dye_material_8, mordant_1, mordant_2, mordant_3, mordant_4, mordant_5, mordant_6, dye_result_1, dye_result_2, dye_result_3, dye_result_4, dye_result_5, dye_result_6, dye_result_7, dye_result_8, dye_result_9, dye_result_10, dye_result_11, dye_result_12)
